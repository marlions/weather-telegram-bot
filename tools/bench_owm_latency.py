...
def main():
    ...
    # Раздельные таймауты: connect обычно маленький, read может быть побольше
    ...
    with httpx.Client(timeout=timeout) as client:
        for i in range(1, n + 1):
            ...
            for attempt in range(1, retries + 2):  # retries=2 => 3 попытки
                try:
                    ...
                    # Это не “шум сети”, это проблема (401/429/5xx). Завершаем с понятным текстом.
